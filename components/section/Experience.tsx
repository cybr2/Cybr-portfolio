...
function Experience() {
    return (
        <section className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 section" id="experience">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="mt-10">
                    Experience Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam quasi perspiciatis repudiandae ipsam aut facere unde adipisci sequi ad quas corporis cum voluptatem, velit veritatis, repellendus magnam? Modi, molestias dolorum.
